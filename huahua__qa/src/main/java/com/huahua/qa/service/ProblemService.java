...
public class ProblemService {
	...
	public Page<Problem> findNewListByLabelId(String label, int page, int size) {
        PageRequest of = PageRequest.of(page - 1, size);
        return problemDao.findNewListByLabelId(label,of);
    }

    public Page<Problem> findHotListByLabelId(String label, int page, int size) {
        PageRequest of = PageRequest.of(page - 1, size);
        return problemDao.findHotListByLabelId(label,of);
    }

    public Page<Problem> findWaitListByLabelId(String label, int page, int size) {
        PageRequest of = PageRequest.of(page - 1, size);
        return problemDao.findWaitListByLabelId(label,of);
    }
}
